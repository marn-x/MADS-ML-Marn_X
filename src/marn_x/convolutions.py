...
def main():
    ...
    search_space = {
        "filters": scope.int(hp.quniform("filters", 80, 200, 10)),
        "units1": scope.int(hp.quniform("units1", 80, 200, 10)),
        "units2": scope.int(hp.quniform("units2", 40, 130, 10)),
    }
